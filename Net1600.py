...
class TransUNet(nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
        ...
        self.vis = Transformer(inc=256,patch=32)
        CH_FOLD2 = 1
        self.Conv0 = encoder_block(ch_in=16,ch_out=int(16*CH_FOLD2))
        ...
        self.Up6 = decoder_conv(ch_in=int(1024), ch_out=int(512))
        self.Up_conv6 = encoder_block(ch_in=int(1024), ch_out=int(512))
        ...
        self.Up1 = decoder_conv(ch_in=int(32), ch_out=int(16))
        self.Up_conv1 = encoder_block(ch_in=int(32), ch_out=int(16))

        self.Conv_1x1 = nn.Conv2d(int(16), output_ch, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, x):
        ...
        trans_input = trans_input.contiguous().view(B, hidden, h, w) 
        ...
        return torch.transpose(d, -1, -2) * d