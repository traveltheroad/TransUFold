...
from TU.data_generator import RNASSDataGenerator, Dataset_1600
import collections
...
def train(net,train_merge_generator,epoches_first):
    ...
    for epoch in range(400):
        ...
        for contacts, seq_embeddings, matrix_reps, seq_lens, seq_ori, seq_name in train_merge_generator:
            ...
            #print(contact_masks)
            contact_masks[:, :seq_lens[0], :seq_lens[0]] = 1
        ...
        if epoch > 10:
            ...
            torch.save(net.state_dict(),  f'../TransUFold_1600_{epoch}.pt')
...
def main():
    ...
    train_merge = Dataset_1600(train_data_list)
